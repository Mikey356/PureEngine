...
#define PURE_PI 3.14159265358979323846	
#define PURE_CONTEXT_VERSION_MAJOR  0x00022002
#define PURE_CONTEXT_VERSION_MINOR  0x00022003
#define	PURE_OPENGL_PROFILE 0x00022008
#define PURE_OPENGL_CORE_PROFILE 0x00032001
#define PURE_OPENGL_DEBUG_CONTEXT 0x00022007
#define PURE_WINDOW GLFWwindow
#define PURE_WINDOW_POINTER GLFWwindow*
